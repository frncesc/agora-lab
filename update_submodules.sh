...
gitcheckout "html/moodle2/local/clickedu" "MOODLE_35_STABLE" "git@github.com:clickedu/ClickeduMoodlePlugin.git"
...
gitcheckout "html/moodle2/mod/questionnaire" "MOODLE_36_STABLE" "https://github.com/remotelearner/moodle-mod_questionnaire.git"
